...
| prometheus-mixin | https://github.com/prometheus/prometheus.git - `v2.34.0` <br> |
| prometheus-operator-mixin | https://github.com/prometheus-operator/prometheus-operator.git - `v0.55.0` <br> |
...
| sealed-secrets-mixin | https://github.com/bitnami-labs/sealed-secrets.git - `v0.17.3` <br> |
| thanos-mixin | https://github.com/thanos-io/thanos.git - `v0.25.1` <br> |
<!-- END_MIXINS_DOC -->
