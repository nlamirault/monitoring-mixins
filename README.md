...
| alloy-mixin | https://github.com/grafana/alloy.git - `v1.0.0` <br> |
...
| prometheus-operator-mixin | https://github.com/prometheus-operator/prometheus-operator.git - `v0.73.2` <br> |
