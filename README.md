...
| alloy-mixin | https://github.com/grafana/alloy.git - `v1.16.1` <br> |
...
| grafana-mixin | https://github.com/grafana/grafana.git - `v13.0.1+security-01` <br> |
...
| kube-state-metrics-mixin | https://github.com/kubernetes/kube-state-metrics.git - `v2.18.0` <br> |
...
| prometheus-operator-mixin | https://github.com/prometheus-operator/prometheus-operator.git - `v0.91.0` <br> |
...
| pyroscope-mixin | https://github.com/grafana/pyroscope.git - `v2.0.2` <br> |
...
| tempo-mixin | https://github.com/grafana/tempo.git - `v2.10.5` <br> |
