...
| grafana-agent-mixin | https://github.com/grafana/agent.git - `v0.29.0` <br> |
| grafana-mixin | https://github.com/grafana/grafana.git - `v9.2.5` <br> |
| istio-mixin | https://github.com/grafana/jsonnet-libs.git - `master` <br> |
| jaeger-mixin | https://github.com/jaegertracing/jaeger - `v1.39.0` <br> |
| kafka-mixin | https://github.com/grafana/jsonnet-libs.git - `master` <br> |
| kube-state-metrics-mixin | https://github.com/kubernetes/kube-state-metrics.git - `v2.6.0` <br> |
...
| loki-mixin | https://github.com/grafana/grafonnet-lib.git - `master` <br> https://github.com/grafana/loki.git - `v2.7.0` <br> |
...
| node-exporter-mixin | https://github.com/prometheus/node_exporter.git - `v1.4.0` <br> |
| osm-mixin | https://github.com/grafana/grafonnet-lib.git - `master` <br> https://github.com/grafana/jsonnet-libs.git - `master` <br> |
| phlare-mixin | https://github.com/grafana/phlare.git - `v0.1.0` <br> |
| postgres-mixin | https://github.com/prometheus-community/postgres_exporter.git - `v0.11.1` <br> |
| prometheus-mixin | https://github.com/prometheus/prometheus.git - `v2.40.2` <br> |
| prometheus-operator-mixin | https://github.com/prometheus-operator/prometheus-operator.git - `v0.60.1` <br> |
| promtail-mixin | https://github.com/grafana/grafonnet-lib.git - `master` <br> https://github.com/grafana/loki.git - `v2.7.0` <br> https://github.com/grafana/loki.git - `v2.7.0` <br> |
| rabbitmq-mixin | https://github.com/grafana/jsonnet-libs.git - `master` <br> |
| sealed-secrets-mixin | https://github.com/bitnami-labs/sealed-secrets.git - `v0.19.1` <br> |
| tempo-mixin | https://github.com/grafana/tempo.git - `v1.5.0` <br> |
| thanos-mixin | https://github.com/thanos-io/thanos.git - `v0.29.0` <br> |
<!-- END_MIXINS_DOC -->
